...
let result =
    ...
    | (14, 1) -> (Day14().partOne (data))
    | (14, 2) -> (Day14().partTwo (data))
    | (15, 1) -> (Day15().partOne (data))
    | (15, 2) -> (Day15().partTwo (data))
    | (16, 1) -> (Day16().partOne (data))
    | (16, 2) -> (Day16().partTwo (data))
    | (17, 1) -> (Day17().partOne (data))
    | (17, 2) -> (Day17().partTwo (data))
    | (18, 1) -> (Day18().partOne (data))
    | (18, 2) -> (Day18().partTwo (data))
